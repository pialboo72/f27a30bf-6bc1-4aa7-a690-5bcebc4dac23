  ...
  useEffect(() => {
    if (id) {
      ...
      const mockData = {
        ...
        category: "文化藝術",
        eligibleApplicants: "非營利組織、學校、個人",
        subsidyScope: "活動費用、設備採購、人事費用",
        contactPerson: "王承辦",
        contactPhone: "02-1234-5678",
        contactEmail: "contact@culture.gov.tw",
        reviewCriteria: "創新性、可行性、社會效益",
        status: "進行中"
      };
      ...
      <div className="fade-in">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">編輯補助案</h1>
